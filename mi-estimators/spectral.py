...
class SpectralNorm(nn.Module):
    def __init__(self, module, k=1, name='weight', power_iterations=1):
    ...
    def _update_u_v(self):
        ...
        # if sigma>self.k:
        w_til= w *self.k/ sigma.expand_as(w)
        # else:
        #     w_til = w
        setattr(self.module, self.name, w_til)
...
class SpectralNorm_wt(nn.Module):
    def __init__(self, module, k=1, name='weight', power_iterations=1):
        super(SpectralNorm_wt, self).__init__()
        self.module = module
        self.name = name
        self.power_iterations = power_iterations
        self.k=k
